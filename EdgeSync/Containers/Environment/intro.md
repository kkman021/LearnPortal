...
## Getting Started
1. Verify your development board model
2. Navigate to the appropriate platform guide in the sidebar (NVIDIA or Qualcomm)
3. Follow the platform-specific setup instructions
4. Verify your environment setup using provided procedures
